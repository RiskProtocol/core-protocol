...
*This function overrides the `withdraw` function from the `IERC4626Upgradeable` interface,
...
Provides a preview of the amount of underlying assets that would be received when
