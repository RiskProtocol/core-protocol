...
async function main() {
    ...
    const transactionResponse = await tokenFactory.buyAsset({ value: ethers.utils.parseEther('9') })
    ...
    await tokenFactory.transfer(0,'0xdD2FD4581271e230360230F9337D5c0430Bf44C0',ethers.utils.parseEther('0.1'))
