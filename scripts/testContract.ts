...
async function main() {
    ...
    console.log(`balance of Atoken0 before funding: ${await tokenFactory.getBalance(0,'0x70997970C51812dc3A010C7d01b50e0d17dc79C8')}`)
    console.log(`balance of Atoken1 before funding: ${await tokenFactory.getBalance(1,'0x70997970C51812dc3A010C7d01b50e0d17dc79C8')}`)

    console.log(`balance of Btoken0 before funding: ${await tokenFactory1.getBalance(0,'0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266')}`)
    console.log(`balance of Btoken1 before funding: ${await tokenFactory1.getBalance(1,'0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266')}`)
    ...
    console.log(`balance of Atoken0 after funding: ${await tokenFactory.getBalance(0,'0x70997970C51812dc3A010C7d01b50e0d17dc79C8')}`)
    console.log(`balance of Atoken1 after funding: ${await tokenFactory.getBalance(1,'0x70997970C51812dc3A010C7d01b50e0d17dc79C8')}`)

    console.log(`balance of Btoken0 after funding: ${await tokenFactory1.getBalance(0,'0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266')}`)
    console.log(`balance of Btoken1 after funding: ${await tokenFactory1.getBalance(1,'0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266')}`)
    ...
    console.log(`balance of Btoken0 after rebase: ${await tokenFactory1.getBalance(0,'0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266')}`)
    console.log(`balance of Btoken1 after rebase: ${await tokenFactory1.getBalance(1,'0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266')}`)
